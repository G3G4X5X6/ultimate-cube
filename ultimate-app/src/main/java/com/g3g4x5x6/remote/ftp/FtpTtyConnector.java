...
@Slf4j
public class FtpTtyConnector implements TtyConnector {
    private String host;
    private int port;
    ...
    public FtpTtyConnector(String host, int port) {
    ...
    public FtpTtyConnector(String host, int port, String user, String Pass) {
        // TODO 密码自动登录
    }

    @Override
    public boolean init(Questioner questioner) {
        log.debug("TelnetTtyConnector >> init(Questioner questioner)");
        return true;
    }
