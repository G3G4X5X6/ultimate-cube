...
public class SerialPane extends JPanel {
    ...
    private @NotNull JediTermWidget createTerminalWidget() {
        JediTermWidget widget = new JediTermWidget(new com.g3g4x5x6.remote.serial.SerialSettingsProvider());
    ...
    private @NotNull TtyConnector createTtyConnector() {
        return new com.g3g4x5x6.remote.serial.SerialTtyConnector(openComPort());
    }
}
